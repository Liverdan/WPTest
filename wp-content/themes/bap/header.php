...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$bap_description = get_bloginfo( 'description', 'display' );
			if ( $bap_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $bap_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
